...
public class TestFinal {
    public static void main(String[] args) {
        ...
        persona1.setNombre("Mariana Cervantes");
        ...
        //empleado1 = new Persona();// No se puede asignar una nueva referencia
        empleado1.setNombre("Aldana Assad");
        System.out.println("empleado1 nombre: "+empleado1.getNombre());
        empleado1.setNombre("Rocio");
        System.out.println("empleado1 nombre: "+empleado1.getNombre());
        empleado1.imprimir();
    }
}